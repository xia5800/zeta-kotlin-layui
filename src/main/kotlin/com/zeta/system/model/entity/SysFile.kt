...
class SysFile : Entity<Long>() {
    ...
    @TableField(value = "biz_type", condition = SqlCondition.LIKE)
    ...
    @TableField(value = "unique_file_name", condition = SqlCondition.LIKE)
    var uniqueFileName: String? = null

    /** 原始文件名 */
    @ApiModelProperty(value = "原始文件名", required = true)
    @TableField(value = "original_file_name", condition = SqlCondition.LIKE)

...
class SysLoginLog : SuperEntity<Long>() {
    ...
    @TableField(value = "comments", condition = SqlCondition.LIKE)
    var comments: String? = null

    /** 操作系统 */
    @ApiModelProperty(value = "操作系统", required = false)
    @TableField(value = "os", condition = SqlCondition.LIKE)
    var os: String? = null

    /** 设备名称 */
    @ApiModelProperty(value = "设备名称", required = false)
    @TableField(value = "device", condition = SqlCondition.LIKE)
    var device: String? = null

    /** 浏览器类型 */
    @ApiModelProperty(value = "浏览器类型", required = false)
    @TableField(value = "browser", condition = SqlCondition.LIKE)

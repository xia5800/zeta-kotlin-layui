...
interface ISysRoleMenuService: IService<SysRoleMenu> {
     ...
     * @return List<Menu>
     */
    fun listMenuByUserId(userId: Long, menuType: List<Int>? = null): MutableList<SysMenu>
     ...
     * @return List<Menu>
     */
    fun listMenuByRoleIds(roleIds: List<Long>, menuType: List<Int>? = null): MutableList<SysMenu>

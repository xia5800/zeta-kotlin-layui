...
import org.zetaframework.extra.file.util.Base64FileUtil
 ...
 */
@Service
class SysFileServiceImpl(private val fileContext: FileContext) : ISysFileService,
     ...
     */
    override fun upload(uploadParam: SysFileUploadParam): SysFile {
        // base64转MultipartFile
        val file = Base64FileUtil.base64Convert(uploadParam.base64!!)
        return upload(file, uploadParam.bizType)
    }

...
class SysRoleMenuServiceImpl(
     ...
     * @return List<Menu>
     */
    override fun listMenuByUserId(userId: Long, menuType: List<Int>?): MutableList<SysMenu> {
     ...
     * @return List<Menu>
     */
    override fun listMenuByRoleIds(roleIds: List<Long>, menuType: List<Int>?): MutableList<SysMenu> {

...
interface QueryController<Entity, Id: Serializable, QueryParam> : PageController<Entity, QueryParam> {
    ...
    @ResponseBody
    @GetMapping("/page")
    fun page(pageParam: PageParam, queryParam: QueryParam?): PageResult<Entity> {
        return super.query(pageParam, queryParam)
    }
    ...
    @ResponseBody
    @GetMapping("/query")
    fun list(param: QueryParam): ApiResult<MutableList<Entity>> {
